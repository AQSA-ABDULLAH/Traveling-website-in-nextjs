    ...
    <div className="lg:pt-0 pt-32">
      <div className="max-w-screen flex flex-col justify-center lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="lg:w-[48%] 2xl:w-[43%] lg:pr-12 2xl:pr-4">
          <h3 className="text-[28px] sm:text-[35px] lg:text-[20px] 2xl:text-[40px] text-[#5E6282] font-poppins font-semibold lg:mb-2">
            Easy and Fast
          </h3>
          <h2 className="text-[32px] sm:text-[60px] lg:text-[53px] 2xl:text-[83px] text-[#14183E] font-volkhov font-bold mb-6">
            ...
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col sm:flex-row text-center sm:text-start items-center gap-3 sm:gap-6 ">
                <div className=" flex items-center justify-center rounded-lg mt-6 sm:mt-0">
                  <img src={step.icon} alt={`${step.title} icon`} className="sm:w-24 sm:h-20 lg:w-16 lg:h-12 2xl:w-32 2xl:h-24" />
                </div>
                <div>
                  <h4 className="text-[24px] sm:text-[32px] lg:text-[18px] 2xl:text-[36px] font-[600] font-poppins text-[#5E6282]">
                    {step.title}
                  </h4>
                  <p className="text-[20px] sm:text-[25px] lg:text-[17px] 2xl:text-[30px] font-poppins leading-7 sm:leading-9 lg:leading-6 2xl:leading-9 text-[#5E6282]">
                    {step.description}
                  </p>
                </div>
              </div>
