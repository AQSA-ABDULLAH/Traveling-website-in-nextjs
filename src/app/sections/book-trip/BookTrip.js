    ...
    <div className="lg:pt-0 pt-32">
      <div className="max-w-screen flex flex-col justify-center lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="lg:w-[48%] 2xl:w-[43%] lg:pr-12 2xl:pr-4">
          ...
          <h2 className="text-[42px] sm:text-[60px] lg:text-[53px] 2xl:text-[83px] text-[#14183E] font-volkhov font-bold mb-6">
          ...
          <div className="lg:w-[440px] 2xl:w-[740px] space-y-4">
            {steps.map((step, index) => (
              <div key={index} className="flex items-center gap-6">
                ...
                <div>
                  <h4 className="text-[29px] sm:text-[32px] lg:text-[18px] 2xl:text-[36px] font-[600] font-poppins text-[#5E6282]">
                    {step.title}
                  </h4>
                  <p className="text-[27px] sm:text-[25px] lg:text-[17px] 2xl:text-[30px] font-poppins leading-9 lg:leading-6 2xl:leading-9 text-[#5E6282]">
                    {step.description}
                  </p>
                </div>
              </div>
