  ...
  return (
    <div className="sm:min-h-screen flex items-center justify-center py-24 sm:py-16">
      <div className="max-w-screen flex flex-col md:flex-row items-center justify-between">
        {/* Left Section */}
        <div className="w-[100%] md:w-[55%] 2xl:w-[600px] desktop:w-[55%] flex flex-col lg:items-start items-center text-center lg:text-left">
        <tag className="text-[14px] sm:text-[22px] lg:text-[20px] 2xl:text-[24px] desktop:text-[28px] text-[#DF6951] uppercase font-semibold mb-8">
            Best Destinations around the world
          </tag>
          <h1 className="text-[32px] px-20 sm:px-0 sm:text-[88px] lg:text-[96px] 2xl:text-[84px] desktop:text-[120px]
          ...
          <p className="text-[12px] px-20 sm:px-0 sm:text-[20px] lg:text-[17px] 2xl:text-[16px] desktop:text-[22px]
          text-[#5E6282] w-[480px] 2xl:w-[600px] desktop:w-[800px] tracking-wider font-medium mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center">
            ...
            <button className="mt-6 sm:mt-2 mr-11 sm:mr-0">
              <img src="/assest/hero/Play Demo.png" alt="Play Demo" className="w-[150px] sm:w-full 2xl:w-[300px]" />
            </button>
          </div>
        </div>
